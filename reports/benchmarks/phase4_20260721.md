...
================================================================================
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          FAISS_DIRECT
  Client Latency: 47.51 ms
  Server Latency: 37.01 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          STATIC_LOOKUP
  Client Latency: 49.70 ms
  Server Latency: 43.11 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          STATIC_LOOKUP
  Client Latency: 35.88 ms
  Server Latency: 29.99 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          STATIC_LOOKUP
  Client Latency: 38.48 ms
  Server Latency: 32.59 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          STATIC_LOOKUP
  Client Latency: 46.48 ms
  Server Latency: 40.44 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          FAISS_DIRECT
  Client Latency: 48.83 ms
  Server Latency: 42.74 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          STATIC_LOOKUP
  Client Latency: 51.38 ms
  Server Latency: 45.69 ms
...
================================================================================
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          STATIC_LOOKUP
  Client Latency: 49.79 ms
  Server Latency: 44.23 ms
  ...
  Client Latency: 47.91 ms
  Server Latency: 42.23 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          STATIC_LOOKUP
  Client Latency: 49.11 ms
  Server Latency: 41.66 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          STATIC_LOOKUP
  Client Latency: 43.74 ms
  Server Latency: 38.42 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          STATIC_LOOKUP
  Client Latency: 47.00 ms
  Server Latency: 40.84 ms
...
================================================================================
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          FAISS_DIRECT
  Client Latency: 47.68 ms
  Server Latency: 42.05 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          STATIC_LOOKUP
  Client Latency: 42.41 ms
  Server Latency: 36.66 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          AMBIGUOUS_MATCH
  Client Latency: 50.17 ms
  Server Latency: 46.40 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          FAISS_DIRECT
  Client Latency: 63.68 ms
  Server Latency: 59.26 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          FAISS_DIRECT
  Client Latency: 45.13 ms
  Server Latency: 41.13 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          STATIC_LOOKUP
  Client Latency: 43.86 ms
  Server Latency: 39.00 ms
...
================================================================================
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          OUT_OF_SCOPE
  Client Latency: 34.75 ms
  Server Latency: 32.20 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          OUT_OF_SCOPE
  Client Latency: 68.90 ms
  Server Latency: 62.43 ms
...
================================================================================
  ...
  ───────────────────────── ─────────────────────────────────────────────────────── ────────────────── ────────────
  Student                   What is UPSDM?                                          FAISS_DIRECT              47.51
  Student                   How can I enroll in a skill development course?         STATIC_LOOKUP             49.70
  Student                   What are the eligibility criteria for the PMKVY scheme? FAISS_DIRECT              47.73
  Student                   Do you provide placement assistance after training?     STATIC_LOOKUP             35.88
  Student                   Where can I find the list of training centers in Luc... STATIC_LOOKUP             38.48
  Student                   What courses are available under UPSDM?                 STATIC_LOOKUP             46.48
  Student                   What is Kaushal Drishti?                                FAISS_DIRECT              48.83
  Student                   What is the helpline number for UPSDM?                  STATIC_LOOKUP             51.38
  Training Partner (TP)     How can I register my institute as a Training Partne... STATIC_LOOKUP             49.79
  Training Partner (TP)     What are the infrastructure requirements for a train... STATIC_LOOKUP             46.51
  Training Partner (TP)     How do I claim reimbursement for candidate training?    AMBIGUOUS_MATCH           47.91
  Training Partner (TP)     What is the empanelment process for new training pro... AMBIGUOUS_MATCH           47.53
  Training Partner (TP)     How to upload student attendance on the portal?         STATIC_LOOKUP             49.11
  Training Partner (TP)     What is the TP grading system?                          STATIC_LOOKUP             43.74
  Training Partner (TP)     What happens if a TP is de-empanelled?                  STATIC_LOOKUP             47.00
  Industrial Partner        How can our company collaborate with UPSDM for hirin... FAISS_DIRECT              47.68
  Industrial Partner        What is the Flexi MoU scheme?                           STATIC_LOOKUP             42.41
  Industrial Partner        Can we customize the training curriculum for our ind... AMBIGUOUS_MATCH           50.17
  Industrial Partner        Are there any financial benefits or subsidies for hi... FAISS_DIRECT              63.68
  Industrial Partner        Who is the nodal officer for industry tie-ups?          FAISS_DIRECT              45.13
  Industrial Partner        What sectors does UPSDM cover for skill training?       STATIC_LOOKUP             43.86
  General / Edge Cases      Hello there!                                            GREETING                   6.26
  General / Edge Cases      Namaste!                                                GREETING                   6.36
  General / Edge Cases      Who is the Prime Minister of Australia?                 OUT_OF_SCOPE              34.75
  General / Edge Cases      What is the capital of France?                          OUT_OF_SCOPE              68.90
  General / Edge Cases      Is there a helpline number for UPSDM?                   STATIC_LOOKUP             47.01
================================================================================
