...
================================================================================
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          FAISS_DIRECT
  Client Latency: 40.62 ms
  Server Latency: 30.69 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          FAISS_DIRECT
  Client Latency: 50.76 ms
  Server Latency: 44.82 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          STATIC_LOOKUP
  Client Latency: 47.77 ms
  Server Latency: 41.64 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          STATIC_LOOKUP
  Client Latency: 54.67 ms
  Server Latency: 48.36 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          STATIC_LOOKUP
  Client Latency: 40.52 ms
  Server Latency: 35.71 ms
...
================================================================================
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          STATIC_LOOKUP
  Client Latency: 52.33 ms
  Server Latency: 47.08 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          STATIC_LOOKUP
  Client Latency: 52.75 ms
  Server Latency: 47.24 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          STATIC_LOOKUP
  Client Latency: 47.60 ms
  Server Latency: 41.54 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          STATIC_LOOKUP
  Client Latency: 42.02 ms
  Server Latency: 37.41 ms
...
================================================================================
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          FAISS_DIRECT
  Client Latency: 51.28 ms
  Server Latency: 45.04 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          STATIC_LOOKUP
  Client Latency: 43.36 ms
  Server Latency: 36.77 ms
  ...
  Client Latency: 53.44 ms
  Server Latency: 47.72 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          FAISS_DIRECT
  Client Latency: 55.51 ms
  Server Latency: 49.43 ms
...
================================================================================
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          OUT_OF_SCOPE
  Client Latency: 43.57 ms
  Server Latency: 38.32 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          OUT_OF_SCOPE
  Client Latency: 41.12 ms
  Server Latency: 37.49 ms
...
================================================================================
  ...
  ───────────────────────── ─────────────────────────────────────────────────────── ────────────────── ────────────
  Student                   What is UPSDM?                                          FAISS_DIRECT              40.62
  Student                   How can I enroll in a skill development course?         STATIC_LOOKUP             52.89
  Student                   What are the eligibility criteria for the PMKVY scheme? FAISS_DIRECT              50.76
  Student                   Do you provide placement assistance after training?     STATIC_LOOKUP             47.77
  Student                   Where can I find the list of training centers in Luc... STATIC_LOOKUP             49.64
  Student                   What courses are available under UPSDM?                 STATIC_LOOKUP             54.67
  Student                   What is Kaushal Drishti?                                FAISS_DIRECT              50.91
  Student                   What is the helpline number for UPSDM?                  STATIC_LOOKUP             40.52
  Training Partner (TP)     How can I register my institute as a Training Partne... STATIC_LOOKUP             52.33
  Training Partner (TP)     What are the infrastructure requirements for a train... STATIC_LOOKUP             52.75
  Training Partner (TP)     How do I claim reimbursement for candidate training?    STATIC_LOOKUP             47.60
  Training Partner (TP)     What is the empanelment process for new training pro... STATIC_LOOKUP             49.96
  Training Partner (TP)     How to upload student attendance on the portal?         STATIC_LOOKUP             48.39
  Training Partner (TP)     What is the TP grading system?                          STATIC_LOOKUP             42.02
  Training Partner (TP)     What happens if a TP is de-empanelled?                  STATIC_LOOKUP             46.26
  Industrial Partner        How can our company collaborate with UPSDM for hirin... FAISS_DIRECT              51.28
  Industrial Partner        What is the Flexi MoU scheme?                           STATIC_LOOKUP             43.36
  Industrial Partner        Can we customize the training curriculum for our ind... AMBIGUOUS_MATCH           53.44
  Industrial Partner        Are there any financial benefits or subsidies for hi... FAISS_DIRECT              55.51
  Industrial Partner        Who is the nodal officer for industry tie-ups?          FAISS_DIRECT              49.55
  Industrial Partner        What sectors does UPSDM cover for skill training?       STATIC_LOOKUP             45.88
  General / Edge Cases      Hello there!                                            GREETING                   6.88
  General / Edge Cases      Namaste!                                                GREETING                   6.07
  General / Edge Cases      Who is the Prime Minister of Australia?                 OUT_OF_SCOPE              43.57
  General / Edge Cases      What is the capital of France?                          OUT_OF_SCOPE              41.12
  General / Edge Cases      Is there a helpline number for UPSDM?                   STATIC_LOOKUP             48.64
================================================================================
