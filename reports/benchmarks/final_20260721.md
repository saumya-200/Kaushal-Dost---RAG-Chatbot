...
================================================================================
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          FAISS_DIRECT
  Client Latency: 97.79 ms
  Server Latency: 79.02 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          FAISS_DIRECT
  Client Latency: 47.17 ms
  Server Latency: 41.34 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          STATIC_LOOKUP
  Client Latency: 46.64 ms
  Server Latency: 39.76 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          STATIC_LOOKUP
  Client Latency: 47.84 ms
  Server Latency: 41.33 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          STATIC_LOOKUP
  Client Latency: 47.11 ms
  Server Latency: 40.74 ms
...
================================================================================
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          STATIC_LOOKUP
  Client Latency: 46.96 ms
  Server Latency: 40.41 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          STATIC_LOOKUP
  Client Latency: 45.74 ms
  Server Latency: 39.72 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          STATIC_LOOKUP
  Client Latency: 58.74 ms
  Server Latency: 53.33 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          STATIC_LOOKUP
  Client Latency: 47.42 ms
  Server Latency: 41.40 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          STATIC_LOOKUP
  Client Latency: 51.44 ms
  Server Latency: 44.40 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          STATIC_LOOKUP
  Client Latency: 42.34 ms
  Server Latency: 37.24 ms
...
================================================================================
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          FAISS_DIRECT
  Client Latency: 51.56 ms
  Server Latency: 44.11 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          STATIC_LOOKUP
  Client Latency: 43.78 ms
  Server Latency: 38.33 ms
  ...
  Client Latency: 45.88 ms
  Server Latency: 40.12 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          FAISS_DIRECT
  Client Latency: 39.51 ms
  Server Latency: 32.76 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          FAISS_DIRECT
  Client Latency: 67.49 ms
  Server Latency: 62.56 ms
...
================================================================================
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          GREETING
  Client Latency: 7.12 ms
  Server Latency: 0.88 ms
  ────────────────────────────────────────────────────────────────────────────
  EXPECTED ANSWER:
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          OUT_OF_SCOPE
  Client Latency: 36.56 ms
  Server Latency: 30.58 ms
...
================================================================================
  ...
  ───────────────────────── ─────────────────────────────────────────────────────── ────────────────── ────────────
  Student                   What is UPSDM?                                          FAISS_DIRECT              97.79
  Student                   How can I enroll in a skill development course?         STATIC_LOOKUP             47.59
  Student                   What are the eligibility criteria for the PMKVY scheme? FAISS_DIRECT              47.17
  Student                   Do you provide placement assistance after training?     STATIC_LOOKUP             46.64
  Student                   Where can I find the list of training centers in Luc... STATIC_LOOKUP             47.84
  Student                   What courses are available under UPSDM?                 STATIC_LOOKUP             47.11
  Student                   What is Kaushal Drishti?                                FAISS_DIRECT              50.94
  Student                   What is the helpline number for UPSDM?                  STATIC_LOOKUP             45.91
  Training Partner (TP)     How can I register my institute as a Training Partne... STATIC_LOOKUP             46.96
  Training Partner (TP)     What are the infrastructure requirements for a train... STATIC_LOOKUP             45.74
  Training Partner (TP)     How do I claim reimbursement for candidate training?    STATIC_LOOKUP             58.74
  Training Partner (TP)     What is the empanelment process for new training pro... STATIC_LOOKUP             47.42
  Training Partner (TP)     How to upload student attendance on the portal?         STATIC_LOOKUP             51.44
  Training Partner (TP)     What is the TP grading system?                          STATIC_LOOKUP             42.34
  Training Partner (TP)     What happens if a TP is de-empanelled?                  STATIC_LOOKUP             47.57
  Industrial Partner        How can our company collaborate with UPSDM for hirin... FAISS_DIRECT              51.56
  Industrial Partner        What is the Flexi MoU scheme?                           STATIC_LOOKUP             43.78
  Industrial Partner        Can we customize the training curriculum for our ind... AMBIGUOUS_MATCH           45.88
  Industrial Partner        Are there any financial benefits or subsidies for hi... FAISS_DIRECT              39.51
  Industrial Partner        Who is the nodal officer for industry tie-ups?          FAISS_DIRECT              67.49
  Industrial Partner        What sectors does UPSDM cover for skill training?       STATIC_LOOKUP             44.84
  General / Edge Cases      Hello there!                                            GREETING                   8.28
  General / Edge Cases      Namaste!                                                GREETING                   7.12
  General / Edge Cases      Who is the Prime Minister of Australia?                 OUT_OF_SCOPE              38.13
  General / Edge Cases      What is the capital of France?                          OUT_OF_SCOPE              36.56
  General / Edge Cases      Is there a helpline number for UPSDM?                   STATIC_LOOKUP             47.54
================================================================================
