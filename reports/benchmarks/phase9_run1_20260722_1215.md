...
================================================================================
  ...
  Client Latency: 71.29 ms
  Server Latency: 51.02 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          STATIC_LOOKUP
  Client Latency: 56.06 ms
  Server Latency: 48.84 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          AMBIGUOUS_MATCH
  Client Latency: 78.59 ms
  Server Latency: 75.30 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          STATIC_LOOKUP
  Client Latency: 51.92 ms
  Server Latency: 45.66 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          STATIC_LOOKUP
  Client Latency: 56.11 ms
  Server Latency: 52.25 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          STATIC_LOOKUP
  Client Latency: 48.96 ms
  Server Latency: 41.24 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          STATIC_LOOKUP
  Client Latency: 47.57 ms
  Server Latency: 44.88 ms
...
================================================================================
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          STATIC_LOOKUP
  Client Latency: 55.32 ms
  Server Latency: 51.37 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          STATIC_LOOKUP
  Client Latency: 55.71 ms
  Server Latency: 52.05 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          STATIC_LOOKUP
  Client Latency: 54.36 ms
  Server Latency: 50.62 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          STATIC_LOOKUP
  Client Latency: 53.81 ms
  Server Latency: 50.21 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          STATIC_LOOKUP
  Client Latency: 64.62 ms
  Server Latency: 58.40 ms
...
================================================================================
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          FAISS_DIRECT
  Client Latency: 51.54 ms
  Server Latency: 45.46 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          STATIC_LOOKUP
  Client Latency: 47.09 ms
  Server Latency: 41.45 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          STATIC_LOOKUP
  Client Latency: 49.78 ms
  Server Latency: 44.05 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          AMBIGUOUS_MATCH
  Client Latency: 52.56 ms
  Server Latency: 46.44 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          FAISS_DIRECT
  Client Latency: 47.35 ms
  Server Latency: 42.16 ms
...
================================================================================
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          GREETING
  Client Latency: 7.96 ms
  Server Latency: 1.19 ms
  ────────────────────────────────────────────────────────────────────────────
  EXPECTED ANSWER:
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          OUT_OF_SCOPE
  Client Latency: 54.83 ms
  Server Latency: 51.50 ms
  ...
  ────────────────────────────────────────────────────────────────────────────
  Stage:          OUT_OF_SCOPE
  Client Latency: 47.01 ms
  Server Latency: 41.28 ms
...
================================================================================
  ...
  ───────────────────────── ─────────────────────────────────────────────────────── ────────────────── ────────────
  Student                   What is UPSDM?                                          AMBIGUOUS_MATCH           71.29
  Student                   How can I enroll in a skill development course?         STATIC_LOOKUP             56.06
  Student                   What are the eligibility criteria for the PMKVY scheme? AMBIGUOUS_MATCH           78.59
  Student                   Do you provide placement assistance after training?     STATIC_LOOKUP             51.92
  Student                   Where can I find the list of training centers in Luc... STATIC_LOOKUP             56.11
  Student                   What courses are available under UPSDM?                 STATIC_LOOKUP             48.96
  Student                   What is Kaushal Drishti?                                AMBIGUOUS_MATCH           50.77
  Student                   What is the helpline number for UPSDM?                  STATIC_LOOKUP             47.57
  Training Partner (TP)     How can I register my institute as a Training Partne... STATIC_LOOKUP             45.39
  Training Partner (TP)     What are the infrastructure requirements for a train... STATIC_LOOKUP             55.32
  Training Partner (TP)     How do I claim reimbursement for candidate training?    STATIC_LOOKUP             55.71
  Training Partner (TP)     What is the empanelment process for new training pro... STATIC_LOOKUP             52.70
  Training Partner (TP)     How to upload student attendance on the portal?         STATIC_LOOKUP             54.36
  Training Partner (TP)     What is the TP grading system?                          STATIC_LOOKUP             53.81
  Training Partner (TP)     What happens if a TP is de-empanelled?                  STATIC_LOOKUP             64.62
  Industrial Partner        How can our company collaborate with UPSDM for hirin... FAISS_DIRECT              51.54
  Industrial Partner        What is the Flexi MoU scheme?                           STATIC_LOOKUP             47.09
  Industrial Partner        Can we customize the training curriculum for our ind... STATIC_LOOKUP             49.78
  Industrial Partner        Are there any financial benefits or subsidies for hi... AMBIGUOUS_MATCH           52.56
  Industrial Partner        Who is the nodal officer for industry tie-ups?          FAISS_DIRECT              47.35
  Industrial Partner        What sectors does UPSDM cover for skill training?       AMBIGUOUS_MATCH           48.64
  General / Edge Cases      Hello there!                                            GREETING                   7.96
  General / Edge Cases      Namaste!                                                GREETING                  17.93
  General / Edge Cases      Who is the Prime Minister of Australia?                 OUT_OF_SCOPE              54.83
  General / Edge Cases      What is the capital of France?                          OUT_OF_SCOPE              47.01
  General / Edge Cases      Is there a helpline number for UPSDM?                   STATIC_LOOKUP             49.91
================================================================================
